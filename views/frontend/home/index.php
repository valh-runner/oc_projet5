...
<div class="col-xs-12 col-sm-6" style="padding-left:0;">
    <div class="col-xs-12 spacer" style="background-color:#ddd; border:1px solid #bbb;">
    ...
    <div class="col-xs-12" style="background-color:#ddd; border:1px solid #bbb;">
...
<div class="col-xs-12 col-sm-6 spacer" style="padding-right:0;">
    <div class="col-xs-12" style="background-color:#ddd; border:1px solid #bbb;">
